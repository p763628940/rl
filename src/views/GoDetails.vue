<template>
    <div class="content" id="applyPassport">
        ...
        <div class="topPart part2">
            ...
            <div class="subButton"><span class="subcontent" v-if="status !==20 && status !==-10">审核中</span><span class="subcontent" v-else>已审核</span></div>
        </div>
        <mt-datetime-picker
                ref="datatimePicker"
                type="date"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.setDetais(this.$route.params.id);
            ...
            getData() {
                ...
                this.$api.getdetails({id:this.$route.params.id}).then((res) => {
                    for (let i = 0; i <res.area.split(",").length; i++) {
                        ...
                        nL.times= new String(res.goCount).split(",")[i]
                        _this.singleApply.push(nL);
                    }
                    console.log( _this.singleApply)
